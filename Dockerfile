...
ARG TIMESCALEDB_VERSION=2.0.0
ARG PG_VERSION=12.5
ARG GO_VERSION=1.15

FROM arm64v8/golang:${GO_VERSION}-alpine AS tools
MAINTAINER Thomas Binder
############################
# Build tools binaries in separate image
############################

ENV TOOLS_VERSION ${GO_VERSION}
...
############################
FROM arm64v8/postgres:${PG_VERSION}-alpine
